...
var newNotice = new obsidian.Notice("Добро пожаловать Obsidian！",1);
var 当前文件;
var 当前文件路径;
var 编辑模式;
var 聚焦编辑 = true;
...
class MyPlugin extends obsidian.Plugin {
    ...
    onload() {
        ...
        */
        ...
        /** Следующие четыре функции слушателя доступны для использования */
    ...
    实用命令菜单() {
        ...
        this.registerDomEvent(this.statusBarIcon, "click", (e) => {
            ...
            menu.addItem((item) => {
                item.setTitle("Настроить плагин");
                item.setIcon("gear");
                item.onClick(() =>{
            ...
            menu.addItem((item) => {
                item.setTitle("Откройте папку плагинов");
                item.setIcon("gear");
                item.onClick(() =>{
            ...
            menu.addItem((item) => {
                item.setTitle("Установить сочетания клавиш");
                item.setIcon("gear");
                item.onClick(() =>{
                    this.app.setting.open();
            ...
            menu.addItem((item) => {
                item.setTitle("удалить все пробелы");
                item.setIcon("bracket-glyph");
                item.onClick(() =>this.去除所有空格());
            });
            menu.addItem((item) => {
                item.setTitle("добавить место");
                item.setIcon("bracket-glyph");
                item.onClick(() =>this.添加间隔空格());
            });
            menu.addItem((item) => {
                item.setTitle("Отступ на два символа в начале строки");
                item.setIcon("indent-glyph");
                item.onClick(() =>this.行首缩进两字符());
            });
            menu.addItem((item) => {
                item.setTitle("Пакетное удаление пустых строк");
                item.setIcon("expand-vertically");
                item.onClick(() =>this.批量去除空行());
            });
            menu.addItem((item) => {
                item.setTitle("Массовая вставка пустых строк");
                item.setIcon("expand-vertically");
                item.onClick(() =>this.批量插入空行());
            });
            menu.addItem((item) => {
                item.setTitle("Свернуть родственные заголовки");
                item.setIcon("double-up-arrow-glyph");
                item.onClick(() =>this.折叠同级标题());
            });
            menu.addItem((item) => {
                item.setTitle("Вставить текущий URL");
                item.setIcon("link");
                item.onClick(() =>this.嵌入当前网址页面());
            });
            menu.addItem((item) => {
                item.setTitle("Получить результаты поиска");
                item.setIcon("link");
                item.onClick(() =>this.获取搜索结果());
            });
            menu.addItem((item) => {
                item.setTitle("Получить текущее количество слов");
                item.setIcon("info");
                item.onClick(() =>this.获取当前字数());
            });
            menu.addItem((item) => {
                item.setTitle("Установить заголовок автоматически");
                item.setIcon("heading-glyph");
                item.onClick(() =>this.自动设置标题());
            });
            menu.addItem((item) => {
                item.setTitle("Преобразовать список в значок");
                item.setIcon("dot-network");
                item.onClick(() =>this.列表转为图示());
            });
            menu.addItem((item) => {
                item.setTitle("Исправление неожиданных разрывов строк");
                item.setIcon("indent-glyph");
                item.onClick(() =>this.修复意外断行());
            });
            menu.addItem((item) => {
                item.setTitle("исправить неправильный синтаксис");
                item.setIcon("check-small");
                item.onClick(() =>this.修复错误语法());
            });
            menu.addItem((item) => {
                item.setTitle("Пакетная конвертация внутренних ссылок");
    ...
    html语法格式刷() {
        ...
        this.registerDomEvent(this.statusBarIcon, "click", (e) => {
            ...
            /*
            menu.addItem((item) => {
                item.setTitle("Открыть расширенную команду");
                item.setIcon("gear");
                item.onClick(() =>{
                    //this.app.setting.open();
            ...
            */
            ...
            menu.addItem((item) => {
                item.setTitle("Верхний индекс ⁺⁻ⁿ");
                item.setIcon("普通格式刷");
                item.onClick(() =>this.上标格式刷());
            });
            menu.addItem((item) => {
                item.setTitle("Индекс ₁₂₃");
                item.setIcon("普通格式刷");
                item.onClick(() =>this.下标格式刷());
            });
            menu.addItem((item) => {
                item.setTitle("~~вычеркнуть~~");
                item.setIcon("普通格式刷");
                item.onClick(() =>this.删除线格式刷());
            });
            menu.addItem((item) => {
                item.setTitle("*курсив*");
                item.setIcon("普通格式刷");
                item.onClick(() =>this.斜体格式刷());
            });
            menu.addItem((item) => {
                item.setTitle("**смелый**");
                item.setIcon("普通格式刷");
                item.onClick(() =>this.粗体格式刷());
            });
            menu.addItem((item) => {
                item.setTitle("==Выделить==");
                item.setIcon("普通格式刷");
                item.onClick(() =>this.高亮格式刷());
            });
            /*
            menu.addItem((item) => {
                item.setTitle("закрыть форматер");
                item.setIcon("cross");
                item.onClick(() =>{
                    this.关闭格式刷();
                    new obsidian.Notice("已关闭格式刷！");
            ...
            .setClass("fontcolor1")
            .setTooltip("fontcolor1")
            .onClick(() => this.彩字格式刷(this.settings.hColor1,'fontcolor1'));
            ...
            .setClass("highlight_btn")
            .setClass("fontcolor2")
            .setTooltip("fontcolor2")
            .onClick(() => this.彩字格式刷(this.settings.hColor2,'fontcolor2'));
         ...
         const fontcolor_btn3 = new obsidian.ButtonComponent(fontcoloritem);
            ...
            .setClass("highlight_btn")
            .setClass("highlight1")
            .setTooltip("highlight1")
            .onClick(() => this.彩底格式刷(this.settings.bColor1,'highlight1'));
...
class editSettingsTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        containerEl.empty();
        containerEl.createEl('h2', { text: "ZH Enhanced editing V"+当前版本 });
        new obsidian.Setting(containerEl)
            .setName("📣 Конвертировать внутренние ссылки「Alt+Z」：Добавить или удалить символы [[ ]] на обоих концах выделения")
            .setDesc("Поддержка пакетного преобразования многострочного текста (разделенного символами новой строки) или текста из нескольких предложений (разделенного запятой).")
        ...
        linkText.appendText("📣 Преобразование синонимичных ссылок「Alt+Q」：Преобразуйте выделенный текст в стиль [[|выделенный текст]] перед выбором документа")
        linkText.appendChild(document.createElement('br'));
        linkText.appendChild(document.createElement('br'));
        linkText.appendText("📣 Преобразовать метку「Alt+Shift+3」：Преобразовать выделенный текст в стиль тега #selected text или обратное преобразование")
        linkText.appendChild(document.createElement('br'));
        div0.appendChild(linkText);

        /*
        new obsidian.Setting(containerEl)
            .setName('📣 Умный перенос строк「Enter」 По умолчанию он поддерживает отступы разрыва строки в ```кодовом блоке```')
            .setDesc('Когда этот параметр включен, новая строка добавляется после нажатия Enter в тексте, который не является списком или блоком кода; если вам нужна обычная новая строка, вы можете нажать Shift+Enter.')
        ...
        */
        ...
        new obsidian.Setting(containerEl)
            .setName("📣 Вставить символ табуляции「Tab」 Вставить эффект табуляции в обычные текстовые строки")
            .setDesc("После включения этого пункта нажмите в строке обычного текста Tab Клавиша вставит 4 пробела, и вся строка больше не будет иметь отступов.")
...
new obsidian.Setting(containerEl)
            .setName("📣 Умный синтаксис 「Alt+;」: автоматически преобразовывать, сопоставлять или пропускать различные типы скобок или синтаксис блока кода")
            .setDesc("Можно преобразовывать [( (< ([ \"[ \'[ и другие комбинации в 〖<[「, или преобразовывать строки, такие как dv qy mm CSS js ty, в блоки кода и преобразовывать текстовые слова в грамматику ссылок выноски .")

        new obsidian.Setting(containerEl)
            .setName("📣 Умная вставка 「Ctrl+Alt+V」: вставьте скопированное содержимое как синтаксис Md")
            .setDesc("Вставьте таблицу, URL-адрес, локальный путь или код непосредственно в таблицу MD, гиперссылку или формат блока кода в соответствии с типом копируемого содержимого.")

        new obsidian.Setting(containerEl)
            .setName("📣 Движение курсора клавиши 「Alt+I, +J, +K, +L」")
            .setDesc("Нажмите Alt + I вверх + J влево + K вниз + L вправо + U в начале текста + N в конце текста сочетания клавиш, чтобы управлять положением перемещения курсора.")

        new obsidian.Setting(containerEl)
            .setName("📣 Прыжок курсора с клавишей 「Alt+Shift +I, +K」")
            .setDesc("Управляйте курсором, чтобы перемещаться вверх и вниз между текстовыми строками, такими как заголовок, список, список дел, блок кода и ссылка, или между символами синтаксиса MD, такими как жирный шрифт, выделение, комментарий, удаление и т. д.")
        
        new obsidian.Setting(containerEl)
            .setName('📣 клавиша управления для переключения файлов в одной папке для отображения "Alt+Shift +U +N」')
            .setDesc('Нажмите клавишу быстрого доступа, чтобы управлять открытием предыдущего или следующего файла в той же папке.')
        
        new obsidian.Setting(containerEl)
            .setName('📣 Установите заголовок и полужирный, наклонный, удалить, выделить и другие эффекты (синтаксис MarkDown).')
            .setDesc('Когда включено, нажмите Alt + Shift + C полужирный + выделение G + зачеркивание S + верхний индекс U + нижний индекс N и другие сочетания клавиш, когда текст не выделен, то есть для включения или отключения синтаксиса MD функция 「Формат по образцу」.')

        var div1 = containerEl.createEl('p', {
            cls: 'recent-files-donation',
        });
var mdText = document.createDocumentFragment();
        mdText.appendText('Преобразовать синтаксис заголовка 「Ctrl+ 1-6」: указать или отменить текущую строку текста как заголовок N-го уровня');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Увеличить уровень заголовка 「не задан」: увеличить текущий уровень заголовка на один уровень (самый высокий - один уровень)');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Уменьшить уровень заголовка 「не задан」: понизить текущий уровень заголовка на один уровень (минимум шесть уровней)');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Преобразовать синтаксис тега 「Alt+Shift+3」: преобразовать выделенный текст в или удалить эффект #tag');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Преобразовать полужирный синтаксис 「Alt+C」: преобразовать выделенный текст в **жирный** эффект или удалить его');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Преобразовать синтаксис курсива 「Alt+X」: преобразовать выделенный текст в *курсивный* эффект или удалить его');
        mdText.appendChild(document.createElement('br'));
        //mdText.appendText('Преобразовать встроенный код 「Alt+D」: преобразовать выделенный текст в эффект встроенного кода или удалить его');
        //mdText.appendChild(document.createElement('br'));
        mdText.appendText('Преобразовать зачеркивание 「Alt+S」: преобразовать или удалить выделенный текст в ~~перечеркнутый~~ эффект');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Преобразовать подчеркивание 「Alt+H」: преобразовать выделенный текст в эффект <u>подчеркивания</u> или удалить его');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Преобразовать блок кода мне задан: преобразовать выделенный текст в ```блок кода``` или удалить эффект ```кодовый блок```');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Преобразовать синтаксис надстрочного индекса 「не задан」: преобразовать выделенный текст в эффект <sup>надстрочного индекса</sup> или удалить его');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Преобразовать синтаксис нижнего индекса 「не задан」: преобразовать выделенный текст в эффект <sub>subscript</sub> или удалить его');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('[[]] преобразуется в синтаксис []() 「не задан」: преобразовать синтаксис [[внутренняя ссылка]] в выделенном тексте в синтаксис [гипер](ссылка)');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('[]() преобразуется в синтаксис [[]] 「не задан」: преобразует синтаксис [super] (ссылка) в выделенном тексте в синтаксис [[внутренняя ссылка]]');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Удалить синтаксис гиперссылки 「не задан」: восстановить стиль гиперссылки []() в выделенном тексте до обычного текста, то есть сохранить содержимое только в []');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Преобразовать неграмматический текст 「Ctrl+Alt+Z」: Щелкните или проведите пальцем по грамматической части текста, чтобы удалить соответствующие грамматические символы MarkDown');
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('Получить неграмматический текст 「Ctrl+Alt+C」: удалить все символы грамматики MarkDown в выделенном тексте и записать в буфер обмена');
        mdText.appendChild(document.createElement('br'));
        div1.appendChild(mdText);

        new obsidian.Setting(containerEl)
            .setName('📣 Установите функцию цветного текстового эффекта (синтаксис HTML).')
            .setDesc('Щелкните цветовой блок, чтобы настроить цвет, выберите текст в области редактирования заметки и нажмите сочетание клавиш 「Ctrl+Shift+1-5」, чтобы преобразовать текст в соответствующий цвет.')
        ...
        */
        ...
        new obsidian.Setting(containerEl)
            .setName('📣 Установите функцию цветового фонового эффекта (синтаксис HTML).')
            .setDesc('Щелкните цветовой блок, чтобы настроить цвет, выберите текст в области редактирования заметки и нажмите сочетание клавиш 「Ctrl+Alt+1-5」, чтобы преобразовать текст в соответствующий цвет фона.')
        ...
        */
        new obsidian.Setting(containerEl)
            .setName('📣 Диапазон прокрутки левого окна')
            .setDesc('Нажмите Alt+Shift+I +K Клавиши быстрого доступа для прокрутки вверх и вниз в левом окне. Перетащите ползунок, чтобы настроить амплитуду прокрутки (значение в пикселях).：')
        ...
        */
        new obsidian.Setting(containerEl)
            .setName('📣 Установите символ, пунктуацию, статус и другие функции преобразования.')

        var div3 = containerEl.createEl('p', {
            cls: 'recent-files-donation',
        });
var charText = document.createDocumentFragment();
        charText.appendText('Исправить неправильную пунктуацию 「не задан」: исправить английскую пунктуацию в середине китайских иероглифов в примечании к китайской пунктуации');
        charText.appendChild(document.createElement('br'));
        charText.appendText('Исправить неправильный синтаксис 「не задан」: исправить неправильный синтаксис MD, такой как 1. Список, ссылка [](), обратная ссылка [[]]() и т. д.');
        charText.appendChild(document.createElement('br'));
        charText.appendText('Преобразовать синтаксис пути 「не задан」: преобразовать синтаксис пути c:\\windows и [](file:///c:\/windows) друг в друга');
        charText.appendChild(document.createElement('br'));
        charText.appendText('Преобразовать упрощенное письмо в традиционное 「не задан」: преобразовать символы упрощенного китайского языка в примечаниях в символы традиционного китайского языка');
        charText.appendChild(document.createElement('br'));
        charText.appendText('преобразовать традиционные китайские символы в упрощенные 「не задан」: преобразовать традиционные китайские символы в заметках в упрощенные китайские символы');
        charText.appendChild(document.createElement('br'));
        charText.appendText('Список преобразуется в иконку 「не задан」: выберите текст списка, преобразуйте его в иконку синтаксиса MerMaid соответствующего уровня и поддержите обновление иконки после изменения списка.');
        charText.appendChild(document.createElement('br'));
        charText.appendText('Преобразовать состояние дела 「не задан」: преобразовать состояние дела в начало выделенной текстовой строки, порядок -[ x-!?><+] эффект');
        charText.appendChild(document.createElement('br'));
        charText.appendText('Отключение преобразования 「не установлено」: преобразовать выделенный текст в или удалить эффект {{c1::selected text}}');
        charText.appendChild(document.createElement('br'));
        charText.appendText('[Выбранный текст] 「Не установлено」: добавить или удалить символ [] с обоих концов выделенного текста');
        charText.appendChild(document.createElement('br'));
        charText.appendText('(Выбранный текст) 「не задан」: Добавить или удалить () символы с обоих концов выделенного текста');
        charText.appendChild(document.createElement('br'));
        charText.appendText('"Выбранный текст" 「не задан」: добавить или удалить символ "" с обоих концов выделенного текста');
        charText.appendChild(document.createElement('br'));
        charText.appendText('"Выбранный текст" 「не задан」: добавить или удалить символ "" с обоих концов выделенного текста');
        div3.appendChild (charText);

        new obsidian.Setting(containerEl)
            .setName('📣 Настройте такие функции, как исправление прерывистых строк, выделение абзацев предложений и встраивание веб-страниц.')

        var div4 = containerEl.createEl('p', {
            cls: 'recent-files-donation',
        });
var toolText = document.createDocumentFragment();
        toolText.appendText('Вычислить выбранный результат 「F9」: Вычислить результат выбранных четырех арифметических выражений и записать в буфер обмена для вставки.');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Исправить случайные разрывы строк, 「не установленные」: исправить случайные разрывы строк в заметках (удалить разрывы строк, которые не заканчиваются пунктуацией предложения)');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Поиск в текущем тексте 「не задан」: поиск выделенного содержимого в текущем документе через панель поиска.');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Выделить весь текущий абзац 「не задан」: выбрать весь текущий абзац текста, в котором находится курсор.');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Выберите текущее предложение 「не задан」: выберите текст текущего предложения (китайский), в котором находится курсор.');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Выберите текущий синтаксис 「Alt+Shift+K」: выберите текст текущего синтаксиса MrakDown (например, полужирный, выделение, удаление, ссылка и т. д.), где находится курсор.');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Получить текст аннотации 「не задан」: получить заголовок, выделение, аннотацию и префикс (# аннотация\аннотация\отражение) и другое текстовое содержимое');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Получить текущее количество символов 「не задан」: Подсчитать количество видимых символов (китайские иероглифы, буквы, цифры, знаки препинания) и невидимых символов (пробелы, разрывы строк) в текущей заметке');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Автоматически установить заголовок 「не задан」: преобразовать однострочный текст (без пунктуации и цифр в конце) в выделенном тексте в заголовок');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Укажите имя текущего файла 「не задан」: выберите текст и укажите его как имя файла текущей заметки.');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Встроить текущую страницу URL 「не задан」: вставить код iframe в конце строки для встраивания выбранной страницы URL');
        toolText.appendChild(document.createElement('br'));
        toolText.appendText('Получить относительный путь 「не задан」: Получить относительный путь к текущей заметке в каталоге библиотеки.');
        toolText.appendChild(document.createElement('br'));
        div4.appendChild (toolText);


        new obsidian.Setting(containerEl)
            .setName('📣 Установите такие функции, как складывание заголовков, добавление или удаление пустых строк или пробелов.')

        var div5 = containerEl.createEl('p', {
            cls: 'recent-files-donation',
        });
        var lineText = document.createDocumentFragment();
        lineText.appendText('Свернуть заголовок того же уровня「Ctrl+Shift+Alt+D」∶ Определите уровень заголовка текущей строки и сразу сложите заголовки одного и того же уровня в теле.');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Исключить текущий абзац「Ctrl+D」∶ Удалите текст текущего абзаца; если содержимое ссылки находится в [[]], оно будет удалено первым; при обнаружении элемента упорядоченного списка последующий порядковый номер будет уменьшен обычным образом.');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Вставить допустимые пустые строки「Ctrl+Shift+Alt+Enter」∶ Вставьте пустую строку с пробелами во всю ширину, чтобы убедиться, что она занимает строку при рендеринге.');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Пробелы в пустые строки「не задан」∶ Преобразование пробелов или табуляции между двумя китайскими иероглифами в пустые строки');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Массовая вставка пустых строк「Ctrl+Shift+L」∶ Пакетная вставка пустых строк в середине выделенных текстовых строк или полного текста');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Пакетное удаление пустых строк「Ctrl+Alt+L」∶ Пакетное удаление пустых строк в выделенном тексте или полном тексте');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Вставьте пустую строку выше「не задан」∶ Вставить пустую строку над текущей строкой текста');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Вставьте пустую строку ниже「не задан」∶ Вставить пустую строку под текущей строкой текста');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Отступ на два символа в начале строки「не задан」∶ Добавляет два полноразмерных пробела в начале каждой строки текста для создания эффекта отступа.');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Добавить пробелы в начале строки「не задан」∶ Добавьте два пробела в начале каждой строки текста');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Удалить ведущие пробелы「не задан」∶ Пакетное удаление начальных пробельных символов из каждой строки текста');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Добавить пробелы в конце「не задан」∶ Добавить два пробела в конце каждой строки текста');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('Удалить конечные пробелы「не задан」∶ Пакетное удаление завершающих пробелов из каждой строки текста');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('добавить место「не задан」：Массовое добавление пробелов между китайскими иероглифами и буквами в тексте, например china 中国。');
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('удалить все пробелы「не задан」：Удалить из текста все полные и полуширинные пробелы');
        lineText.appendChild(document.createElement('br'));
        ...
        qqText.appendText('🆗 Все желающие могут выдвигать рабочие требования и предложения в Canzi (QQ: 312815311), и давайте работать вместе, чтобы улучшить функцию редактирования!');
        qqText.appendChild(document.createElement('br'));
        qqText.appendText('🆗 Спасибо Cuman (QQ: 35669852) за руководство и отладку.');
